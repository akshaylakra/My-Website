...
const socials = [
  { name: "linkedin" as const, label: "LinkedIn", href: "https://www.linkedin.com/in/akshaylakra/" },
  { name: "instagram" as const, label: "Instagram", href: "https://instagram.com/akshay_decodes" },
  { name: "youtube" as const, label: "YouTube", href: "https://www.youtube.com/@akshay_decodesYT" },
  { name: "twitter" as const, label: "Twitter / X", href: "https://x.com/akshaylkr" },
];
